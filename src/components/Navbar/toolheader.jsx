...
const ToolHeader = () => {
  return (
    <>
      <nav className="navbar pt-5 shadow fixed top-0 z-50 bg-[#513192] text-white">
        ...
        <div className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1">
            <li tabIndex={0}>
              <details>
                <summary className="hover:bg-[#513192] hover:text-white">
                  <svg
                ...
                <ul className="p-2 text-black font-medium">
                  <li>
